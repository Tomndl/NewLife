// Configuration
const discordLink = 'https://discord.gg/newlifewl';
const serverIP = 'connect.g45.hopeheberg.fr:31210';

// Fonction pour accéder au site (splash screen)
function accessSite() {
    ...
    // Après l'animation de sortie, afficher le contenu principal
    setTimeout(() => {
        // Masquer la splash screen
        splashScreen.style.display = 'none';
        
        // Afficher le contenu principal
        body.classList.add('content-visible');
        
        // Initialiser les animations du site
        initializeSiteAnimations();
    }, 800);
}

// Fonction pour initialiser les animations du site
...
document.addEventListener('DOMContentLoaded', () => {
    // Les animations seront initialisées après la splash screen
    // Voir la fonction initializeSiteAnimations()
});
...
// L'initialisation des statistiques sera gérée par initializeSiteAnimations()
